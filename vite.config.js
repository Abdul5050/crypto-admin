...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        start_url: ".",
        id: ".",
        short_name: "Crypto - E-Commerce Website",
        name: "Crypto | React eCommerce Admin Dashboard",
        description:
          "Crypto : React Js Grocery & Organic Food Store e-commerce Admin Dashboard",
        icons: [
          {
            src: "favicon.ico",
            sizes: "48x48",
  ...
  server: {
    proxy: {
      "/api/": {
        target: "https://crypto-api-silk.vercel.app",
        changeOrigin: true,
      },
    },
  },
